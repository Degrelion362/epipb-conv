...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const messages = [
  `<span>Petit secret #1 : il y a 28 Petits Secrets...</span><span>Serez‑vous assez confiants pour tous les retrouver ?</span>`,
  ...
  `<span>Petit secret #4 : il y a en tout, 39 Morceaux Musicals de M (56 si on comptes les brouillons)</span><span>Seulement 13 accessibles dans un dossier secret.</span>`,
  ...
  `<span>Petit secret #28 : prout.</span><span>Je n'avais plus d'idées...</span>`
];
